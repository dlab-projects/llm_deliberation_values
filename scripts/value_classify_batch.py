...
with open(here('data/analysis/asynchronous_h2h_claude37_gpt41_exp3_alternate_prompt_xml.pkl'), 'rb') as file:
    df = pickle.load(file)
...
batch_input_file = here(f"data/jobs/testing_agent1_again.jsonl")
